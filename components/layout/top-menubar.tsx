...
import { Laptop, Moon, Sun, MoreHorizontal, Settings, HelpCircle, Menu } from "lucide-react";
...
export function TopMenuBar() {
    ...
    return (
        <div className="sticky top-0 z-50 flex h-16 w-full shrink-0 items-center justify-between border-b bg-background px-4">
